...
/** Multistate Monitor Widget
 *  @author Davy Dequidt
 */
public class MultistateMonitorWidget extends PVWidget
{
    static
    {
        WidgetFactory.addJavaScript("multistatemonitor.js");
        WidgetFactory.registerLegacy("org.csstudio.opibuilder.widgets.symbol.multistate.MultistateMonitorWidget", "multistatemonitor");

    }

    private final String imgUrl;

    public MultistateMonitorWidget(final ParentWidget parent, final Element xml) throws Exception
    {
        super(parent, xml, "multistatemonitor", 150, 100);
